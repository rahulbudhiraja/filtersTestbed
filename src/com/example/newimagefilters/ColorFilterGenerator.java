...
import android.graphics.ColorMatrixColorFilter;
	...
	public class ColorFilterGenerator {
		...
		public static ColorMatrix adjustBrightness(ColorMatrix cm, float value) {
		...
		public static ColorMatrix adjustContrast(int value) {
		...
		public static ColorMatrix adjustSaturation( float value) {
